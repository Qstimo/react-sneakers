    ...
    <header className="d-flex justify-between align-center p-40">
      <Link to="/">
        <div className="d-flex align-center">
          ...
          <img width={40} height={40} alt="logo" src="/img/logo.png"></img>
      ...
      <ul className="d-flex">
        ...
        <li>
          <Link to='favorites'>
            <img className="mr-25 cu-p" src="/img/heart.svg" alt="Избранное" />
          </Link>

        </li>
        <li>
          <Link to='/orders'>
          <img className="mr-25 cu-p" src="/img/union.svg" alt="Заказ" />
          </Link>
        </li>
      </ul>
    </header>
